...
const UserWiseSummary = () => {
  ...
  const handleChange = (event) => {
    ...
    setFilterDate(date);
    console.log(filterdate);
    getClaimUserSummary({ date: filterdate })
      .then((data) => {
        console.log(data);
        if (data) {
          setDataa(data);
    ...
    <>
      <section className="card mb-4">
        <header className="card-header">
          ...
          <h2 className="card-title-ppp colordgrey">
            User Wise Summary
        ...
        <div className="card-body">
          <table
            id="process-manager-table"
            className="table table-sm mb-0"
          >
            <thead>
              <tr>
                <th className="thcolo tdsixtypc">USER NAME</th>
            ...
            <table className="table table-sm mb-0">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-right tetdbold tdtwentypc">{totalClaims}</td>
...
export default UserWiseSummary;
