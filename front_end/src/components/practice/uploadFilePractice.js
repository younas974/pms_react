...
const handleFormSubmit =()=>{
    ...
    fileList.map(item=>{
        ...
        formData.append('practice_id', item.practice_id);
    ...
    api
    .post("/api/practice/documents", formData)
    .then((res) => {
        onTrigger(true)
...
<div>
        ...
        return  <> <div className="row"><div className="col-md-6 col-sm-6 col-xs-6"><AttachmentIcon/> {item.uploadfile[0].name}
