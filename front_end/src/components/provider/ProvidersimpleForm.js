...
import { wrapDatePicker } from "../helper/datepicker";
      ...
      <div>
        ...
        <div className="input-row exp">
          <Field
            ...
            style={{ width: "100%" }}
          />
          <Field name="created_by" type="hidden" component={renderField} />
          <Field name="updated_by" type="hidden" component={renderField} />
        </div>
      </div>
    </div>
  );
...
const renderMembers = ({ fields, meta: { touched, error, submitFailed } }) => (
  <React.Fragment>
    ...
    {fields.map((member, index) => (
      <div
        className="col-lg-6 row paddingtop1rem"
...
const SubmitAddProviderForm = (props) => {
  ...
  return (
    <form className="form-horizontal form-bordered" onSubmit={handleSubmit}>
      <div className="form-group row">
        <label className="col-lg-2 control-label text-lg-right pt-2">
          First Name:
        </label>

        <div className="col-lg-3">
          <Field name="providerFirstName" type="text" component={renderField} />
        </div>
        ...
        <div className="col-lg-3">
          <Field name="providerLastName" type="text" component={renderField} />
        </div>
      </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <Field name="individualNPI" type="text" component={renderField} />
        </div>
      </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <Field name="createdById" type="hidden" component={renderField} />

          <Field name="updatedById" type="hidden" component={renderField} />

          <Field name="Jobtitle" type="text" component={renderField} />
        </div>
        ...
        <div className="col-lg-3">
          <Field name="speciality" type="text" component={renderField} />
        </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <Field name="CdsPharmacy" type="text" component={renderField} />
        </div>
        ...
        <div className="col-lg-3">
          <Field name="CAQHID" type="text" component={renderField} />
        </div>
      </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <FormSection name="state_licence">{CustomFields()}</FormSection>
        </div>
        ...
        <div className="col-lg-3">
          <Field name="CARFAcceditation" type="text" component={renderField} />
        </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <FormSection name="driving_licence">{CustomFields()}</FormSection>
        </div>
        ...
        <div className="col-lg-3">
          <FormSection name="dae_certification">{CustomFields()}</FormSection>
        </div>
        ...
        <div className="col-lg-3">
          <FormSection name="caqh_creditional">{CustomFields()}</FormSection>
        </div>
      </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <Field name="medicaidTPIGroup" type="text" component={renderField} />
        </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <Field name="emailAddress" type="text" component={renderField} />
        </div>
      </div>
      ...
      <div className="form-group row">
        ...
        <div className="col-lg-3">
          <Field name="medicarePTAN" type="number" component={renderField} />
        </div>
      ...
      <div className=" text-lg-right btn-ask-marj">
        <button
          ...
          onClick={reset}
          className="mb-1 mt-1 mr-1 btn btn-default text-lg-right"
        >
        ...
        <button
          type="submit"
          disabled={submitting}
          className="mb-1 mt-1 mr-1 btn btn-primary text-lg-right"
        >
